...
// console.log(`It would take ${spaceCraftName} ${daysToMars} days to get to Mars.`);
...
// console.log(`It would take ${spaceCraftName} ${getDaysToLocation(kilometersToMoon)} days to get to the Moon.`);
